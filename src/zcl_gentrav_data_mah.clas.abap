CLASS zcl_gentrav_data_mah DEFINITION
...
CLASS zcl_gentrav_data_mah IMPLEMENTATION.

METHOD if_oo_adt_classrun~main.

DATA itab TYPE TABLE OF ztrav_data_mah.
...
DELETE FROM ztrav_data_mah.

* insert the new table entries

INSERT ztrav_data_mah FROM TABLE @itab.
